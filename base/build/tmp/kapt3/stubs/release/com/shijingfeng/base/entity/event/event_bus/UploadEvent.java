...
public final class UploadEvent {
    ...
    public UploadEvent(long currentLength, long totalLength, boolean done, @org.jetbrains.annotations.Nullable()
    java.lang.String tag) {
        super();
    }
    
    public UploadEvent(long currentLength, long totalLength, boolean done) {
        super();
    }
    
    public UploadEvent(long currentLength, long totalLength) {
        super();
    }
    ...
    public final com.shijingfeng.base.entity.event.event_bus.UploadEvent copy(long currentLength, long totalLength, boolean done, @org.jetbrains.annotations.Nullable()
    java.lang.String tag) {
        return null;
    }
