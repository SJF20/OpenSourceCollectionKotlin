...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.shijingfeng.base.util.image_load.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.shijingfeng.base.util.image_load.GlideOptions().apply(toSet));
    }
  }
}
