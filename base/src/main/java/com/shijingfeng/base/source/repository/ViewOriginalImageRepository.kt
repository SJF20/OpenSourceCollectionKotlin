package com.shijingfeng.base.source.repository

import com.shijingfeng.base.base.repository.BaseRepository
import com.shijingfeng.base.base.source.BaseLocalSource
import com.shijingfeng.base.common.extension.OnFailure
import com.shijingfeng.base.common.extension.OnSuccess
import com.shijingfeng.base.source.network.ViewOriginalImageNetworkSource
...
fun getViewOriginalImageRepositoryInstance(
    ...
    if (sInstance == null) {
        synchronized(ViewOriginalImageRepository::class.java) {
            if (sInstance == null) {
                sInstance = ViewOriginalImageRepository(networkSource)
            }
        }
    }
    return sInstance!!
...
class ViewOriginalImageRepository(
    networkSource: ViewOriginalImageNetworkSource? = null
) : BaseRepository<BaseLocalSource, ViewOriginalImageNetworkSource>(mNetworkSource = networkSource) {
