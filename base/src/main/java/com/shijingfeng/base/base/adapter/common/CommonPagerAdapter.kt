package com.shijingfeng.base.base.adapter.common
...
open class CommonPagerAdapter<T>(
    ...
    protected var mOnItemEvent: ((view: View?, data: Any?, position: Int, flag: String) -> Unit)? = null
     ...
     */
    fun setOnItemEventListener(onItemEvent: (view: View?, data: Any?, position: Int, flag: String) -> Unit) {
