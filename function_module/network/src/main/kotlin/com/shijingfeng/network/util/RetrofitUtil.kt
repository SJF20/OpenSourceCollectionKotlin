...
import com.shijingfeng.base.util.gson
import com.shijingfeng.network.constant.BASE_URL_VALUE_WAN_ANDROID
import com.shijingfeng.network.http.cookie.CookieJarImpl
import com.shijingfeng.network.http.cookie.store.PersistentCookieStore
import com.shijingfeng.network.http.factory.CustomGsonConverterFactory
import com.shijingfeng.network.http.interceptor.CacheInterceptor
import com.shijingfeng.network.http.interceptor.ProgressInterceptor
...
object RetrofitUtil {
    ...
    private fun initRetrofit(): Retrofit {
        ...
        val okHttpClientBuilder = OkHttpClient().newBuilder()
            ...
            //设置CookieJar（存储到磁盘）
            .cookieJar(CookieJarImpl(PersistentCookieStore(application)))
            //添加SSL验证机制
            .sslSocketFactory(
