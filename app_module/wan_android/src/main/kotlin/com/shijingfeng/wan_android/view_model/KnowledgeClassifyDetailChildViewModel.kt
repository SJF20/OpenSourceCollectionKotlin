...
internal class KnowledgeClassifyDetailChildViewModel(
    ...
    private fun getKnowledgeClassifyChildList(page: Int) {
        mRepository?.getKnowledgeClassifyDetailChild(
            page = page,
            ...
            onSuccess = onSuccessLabel@{ knowledgeClassifyChild ->
                ...
                val event = ListDataChangeEvent<KnowledgeClassifyDetailChildItem>()
    ...
    fun collected(articleId: String) {
        mRepository?.collected(articleId, onSuccess = {
            ...
            EventBus.getDefault().post(ArticleCollectionEvent(
                fromName = KnowledgeClassifyDetailChildFragment::class.java.name,
                id = articleId,
                collected = true
            ))
        })
