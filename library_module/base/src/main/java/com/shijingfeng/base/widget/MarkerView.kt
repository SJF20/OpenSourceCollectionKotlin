...
import com.shijingfeng.base.annotation.define.MarkerViewPosition
import com.shijingfeng.base.annotation.define.MarkerViewPosition.*
import com.shijingfeng.base.annotation.define.MarkerViewStyle
import com.shijingfeng.base.annotation.define.MarkerViewStyle.*
...
class MarkerView @JvmOverloads constructor(
    ...
    private var mCornerRadius = SizeUtils.dp2px(5F).toFloat()

    /** 缺失的三角形(整体的三角形缩小版)的腰长(等腰三角形) (在缺失三角形样式下有效, 默认5dp) */
    private var mMissingTriangleWaistLength = SizeUtils.dp2px(5F).toFloat()
    ...
    init {
        context.obtainStyledAttributes(attrs, R.styleable.MarkerView).run {
            ...
            mTextSize = getDimension(R.styleable.MarkerView_textSize, SizeUtils.sp2px(8F).toFloat())
            ...
            mCornerRadius = getDimension(R.styleable.MarkerView_cornerRadius, SizeUtils.dp2px(5F).toFloat())
...
//        mCornerRadius = SizeUtils.dp2px(100F).toFloat()
//        mMissingTriangleWaistLength = SizeUtils.dp2px(100F).toFloat()
////        mOffset = SizeUtils.dp2px(20F).toFloat()
//        val paddingTop = SizeUtils.dp2px(50F).toFloat()
//        val paddingBottom = SizeUtils.dp2px(50F).toFloat()
//        val paddingStart = SizeUtils.dp2px(50F).toFloat()
//        val paddingEnd = SizeUtils.dp2px(50F).toFloat()
