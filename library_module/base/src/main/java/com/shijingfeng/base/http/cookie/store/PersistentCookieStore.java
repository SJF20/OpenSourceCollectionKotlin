...
public class PersistentCookieStore implements CookieStore {
    ...
    /** 将url的所有Cookie保存在本地 */
    @Override
    public void saveCookieList(HttpUrl url, List<Cookie> urlCookies) {
        if (!cookies.containsKey(url.host())) {
        ...
        for (Cookie cookie : urlCookies) {
            ...
            if (isCookieExpired(cookie)) {
                ...
                saveCookieList(url, cookie, getCookieToken(cookie));
            }
        }
    }
     ...
     */
    private void saveCookieList(HttpUrl url, Cookie cookie, String name) {
        //内存缓存
    ...
    @Override
    public boolean removeCookieList(HttpUrl url) {
        if (cookies.containsKey(url.host())) {
            //文件移除
