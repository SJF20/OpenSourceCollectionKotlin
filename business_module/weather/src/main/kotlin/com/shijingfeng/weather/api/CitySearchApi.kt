...
import com.shijingfeng.network.constant.BASE_URL_NAME_AMAP_CITY_SEARCH
import com.shijingfeng.network.constant.BASE_URL_NAME_WEATHER
...
internal interface CitySearchApi {
     ...
     * @param lngLatBatchStr 经纬度, 可批量查询，一次最多20个  格式例子: "经度,纬度|经度,纬度"
